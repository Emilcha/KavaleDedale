            ...
            if self.runMenu == True:
                ...
                for ev in pygame.event.get(): 
                    ...
                    if ev.type == pygame.MOUSEBUTTONDOWN: 
                        ...
                        if self.widthDocu/2 <= mouse[0] <= self.widthDocu/2+140 and self.heightDocu/2 <= mouse[1] <= self.heightDocu/2+40: 
                            pass
                ...
                self.window.blit(self.textDocu , (self.widthDocu/2 - 40 ,self.heightDocu/2 + 3))
